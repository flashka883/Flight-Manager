...
<body>
    <style>
        ...
        .auth .inner .right form .group{
             display: flex;
        }

        .auth .inner .right form .group>input{
            width: calc(100% - (2 * 14));
            padding: 14px;
            border-radius: 40px;
        ...
        .auth .inner .right form .group>input:focus{
        ...
        <div class="link-inner-holder">
            ...
            <div class="inner">
                <div class="left">
                    ...
                    <span class="welcome-message"> Register and find your destination. </span>
                </div>
                <div class="right">
